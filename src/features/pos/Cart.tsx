...
export function Cart({
  ...
  return (
    <aside className="sticky top-4 flex flex-col overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-lg max-[1100px]:static dark:border-slate-800 dark:bg-[#111827]">
