-- Panda Stock — Esquema de base de datos (SQLite)
-- Exportado desde panda_stock.db
...
CREATE UNIQUE INDEX IF NOT EXISTS "categorias_nombre_unique" ON "categorias" ("nombre");
...
CREATE UNIQUE INDEX IF NOT EXISTS "marcas_nombre_unique" ON "marcas" ("nombre");
...
CREATE UNIQUE INDEX IF NOT EXISTS "productos_codigo_interno_unique" ON "productos" ("codigo_interno");
